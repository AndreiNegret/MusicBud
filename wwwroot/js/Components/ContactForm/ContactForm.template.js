Vue.component('contact-form', {
    template: `
        <div class="contact-form form-overlay" :class="{ 'show-form-overlay': isExpanded }">
            <div id="form-container" :class="{ 'expand': isExpanded }">
                <span class="form-controls" @click="toggleExpanded">
                    <i class="fa fa-window-close" v-if="isExpanded"></i> 
                ...
                <div id="form-content" v-show="isExpanded" :class="{ 'show-form-overlay expand': isExpanded }">
                    ...
                    <form @submit.prevent="submitForm">
                        <input class="input name" :class="{'form-error': !form.fields.username.isValid}" name="username" placeholder="Your name please" type="text" v-model="form.fields.username.value" required>
